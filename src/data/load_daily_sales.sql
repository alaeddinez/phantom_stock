...
select NUM_ART,NUM_ETT,DAT_VTE,week_of_year,year_of_calendar, sum(QTE_VTE) as QTE_VTE from (
...
group by NUM_ART,NUM_ETT,DAT_VTE,week_of_year,year_of_calendar
